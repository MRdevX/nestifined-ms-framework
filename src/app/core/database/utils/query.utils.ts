...
export class QueryUtils {
  static buildSearchOptions(
    ...
    return {
      ...
      filters: QueryUtils.buildFilters(filters),
      relations: relations || [],
      select: select || [],
      withPagination,
    };
  ...
  static buildFilters(filterDto?: FilterDto): FilterOptions {
    if (!filterDto) return {};
  ...
  static parseDateFilter(value: string): { operator: string; date: Date } | null {
  ...
  static buildSearchQuery(searchTerm: string, searchableFields: string[]): string {
